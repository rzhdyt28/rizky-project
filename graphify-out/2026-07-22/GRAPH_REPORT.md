# Graph Report - rizky-project  (2026-07-22)

## Corpus Check
- 232 files · ~55,478 words
- Verdict: corpus is large enough that graph structure adds value.

## Summary
- 997 nodes · 1671 edges · 124 communities (92 shown, 32 thin omitted)
...
2. `SawCase` - 31 edges
3. `InvitationLookResource` - 29 edges
4. `Tenant` - 26 edges
5. `Theme` - 26 edges
6. `User` - 22 edges
7. `PlanLimitService` - 22 edges
8. `ThemeOptionsSchema` - 14 edges
9. `Plan` - 13 edges
10. `InvitationController` - 13 edges
...
Cohesion: 0.10
Nodes (13): AlternativesRelationManager, CriteriaRelationManager, Model, TenantsRelationManager, EventsRelationManager, GalleryPhotosRelationManager, GiftsRelationManager, GuestsRelationManager (+5 more)
...
Cohesion: 0.20
Nodes (6): CreateContactMessage, CreatePortfolioEducation, CreateSawCase, CreateCustomer, CreateSubscription, Filament\Resources\Pages\CreateRecord
...
Cohesion: 0.17
Nodes (5): AgentStats, AgentController, JobApplication, RunLog, Filament\Widgets\StatsOverviewWidget
...
Cohesion: 0.19
Nodes (3): Theme, InvitationThemeProvisioner, Get
...
Cohesion: 0.14
Nodes (5): CreateTheme, ThemeResource, ThemeAsset, ThemeAssetSeeder, Illuminate\Database\Eloquent\Builder

### Community 116 - "ContactMessageResource.php"
Cohesion: 0.18
Nodes (4): PortfolioEducationResource, CreatePortfolioExperiencePhoto, PortfolioExperiencePhotoResource, Filament\Resources\Resource

### Community 117 - "Illuminate\Database\Seeder"
Cohesion: 0.18
Nodes (6): Plan, Guest, DatabaseSeeder, InvitationDemoSeeder, PlanFeatureSeeder, Illuminate\Database\Seeder
...
### Community 121 - "InvitationResource"
Cohesion: 0.67
...
- **Why does `Invitation` connect `autoload-dev` to `User`, `SubscriptionResource`, `CreateActivityLogTable`, `Illuminate\Database\Eloquent\Model`, `GiftController`, `Payment`, `Illuminate\Database\Eloquent\Model`, `GuestSheetImporter`, `GalleryPhotoController`, `Illuminate\Database\Seeder`, `InvitationController.php`, `GalleryPhotoController`, `BelongsToTenant.php`, `PortfolioExperienceResource.php`, `Illuminate\Routing\Controller`?**
  _High betweenness centrality (0.065) - this node is a cross-community bridge._
- **Why does `Theme` connect `GalleryPhotoController` to `Illuminate\Database\Eloquent\Model`, `Illuminate\Database\Eloquent\Model`, `ThemeResource.php`, `keywords`, `autoload-dev`, `Illuminate\Database\Seeder`?**
  _High betweenness centrality (0.036) - this node is a cross-community bridge._
- **Why does `User` connect `User` to `Invitation`, `AdminPanelProvider.php`, `Illuminate\Database\Seeder`?**
